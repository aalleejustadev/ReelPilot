...
// Accessibility edit (2026-09-25): inactive text uses text-muted-foreground
// instead of vega's text-foreground/60, which is 4.36:1 on the tab track and
// fails WCAG AA (4.5:1). Found by the axe scan in tests/e2e/a11y.spec.ts.
